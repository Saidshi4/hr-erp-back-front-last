          ...
          <div className="flex-1">
            {activeTab === 'profile' && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-base font-semibold text-gray-800 mb-5">User Profile</h2>
            ...
            {activeTab === 'system' && (
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h2 className="text-base font-semibold text-gray-800 mb-5">System Settings</h2>

                <div className="space-y-5">
                  <div className="flex items-center justify-between py-4 border-b border-gray-100">
                    <div>
                      <p className="text-sm font-medium text-gray-800">Device Auto-Sync</p>
                      <p className="text-xs text-gray-400 mt-0.5">Automatically sync attendance data from devices</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between py-4 border-b border-gray-100">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">Receive email alerts for leave approvals</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="flex items-center justify-between py-4 border-b border-gray-100">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">Log all user actions for compliance</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" defaultChecked />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-purple-300 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple-500"></div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="pt-5 border-t border-gray-100">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between py-3 px-4 rounded-lg" style={{ background: '#f8fafc' }}>
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Active now · This device</p>
                        </div>
                    ...
                    <div className="mt-3">
                      <p className="text-xs text-gray-400 mb-1.5">JWT Token Expiration</p>
                      <p className="text-sm font-medium text-gray-700">24 hours (configured in backend)</p>
                    </div>
                  </div>
                </div>
              </div>
